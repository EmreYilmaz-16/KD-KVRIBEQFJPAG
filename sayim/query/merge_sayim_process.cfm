...
select SAYIM_ID,SERIAL_NUMBER,PRODUCT_ID,STOCK_ID,SHELF_NUMBER,PRODUCT_CODE_2,"CONVERT(VA)" from  w3Qa_1.PBS_SERIAL_SAYIM_ROW WHERE SAYIM_ID IN (#attributes.SAYIM_IDS#)
</cfquery>
