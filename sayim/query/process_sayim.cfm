...
select PRODUCT_ID,STOCK_ID,SHELF_NUMBER,COUNT(*) AS QUANTITY,PRODUCT_CODE_2 from #dsn3#.PBS_SERIAL_SAYIM_ROW WHERE SAYIM_ID=#attributes.sayim_id# GROUP BY PRODUCT_ID,STOCK_ID,SHELF_NUMBER,PRODUCT_CODE_2
</cfquery>
...
SELECT SERIAL_NUMBER,STOCK_ID,SHELF_NUMBER,PP.PRODUCT_PLACE_ID FROM #dsn3#.PBS_SERIAL_SAYIM_ROW
LEFT JOIN #dsn3#.PRODUCT_PLACE AS PP ON PP.SHELF_CODE=PBS_SERIAL_SAYIM_ROW.SHELF_NUMBER
