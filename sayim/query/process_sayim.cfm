...
select PRODUCT_ID,STOCK_ID,SHELF_NUMBER,COUNT(*) AS QUANTITY,PRODUCT_CODE_2 from w3Qa_1.PBS_SERIAL_SAYIM_ROW WHERE SAYIM_ID=#attributes.sayim_id# GROUP BY PRODUCT_ID,STOCK_ID,SHELF_NUMBER,PRODUCT_CODE_2
</cfquery>
