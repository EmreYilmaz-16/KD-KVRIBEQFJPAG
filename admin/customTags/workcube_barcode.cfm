    ...
    <cftry>
        ...
        <cfif attributes.show eq 1>
        	<cfif attributes.rotate neq 1>  
                <cfif caller.app_server_type eq 'coldfusion'>
                    <cfimage name="#attributes.id#" action="writeToBrowser" source="#img#" format="jpg">
                <cfelse>
                    <cfoutput>#img#</cfoutput>
                </cfif>
                <!---<cfoutput><img src="#img#" name="#attributes.id#" id="#attributes.id#"></cfoutput>---->
            <cfelse>
            	<cfimage source="#img#" name="barcod" overwrite="yes" action="write" destination="..\documents\barcode\barkod#attributes.value#.jpg">
            	<cfimage name="#attributes.id#2" action="rotate" angle="90" source="..\documents\barcode\barkod#attributes.value#.jpg" format="jpg">
