                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:openselectProducts(#PRODUCT_ID#,#QUANTITY#,#IS_SERIAL_NO#,#getEmirDetail.PRODUCT_ID#,#QUANTITY * getEmirDetail.AMOUNT#)" 
                                   ...
                                   title="Seç">Seç</a>
                                   <a href="javascript:openselectedProducts(#PRODUCT_ID#,#QUANTITY#,#IS_SERIAL_NO#,#getEmirDetail.PRODUCT_ID#,#QUANTITY * getEmirDetail.AMOUNT#)" 
                                   class="karma-action-link" 
                                   title="Seç">Göster</a>
                            </td>
                        </tr>
...
<script>
    ...
    function openselectedProducts(PRODUCT_ID,QUANTITY,IS_SERIAL_NO,MAIN_PRODUCT_ID,REQUIRED_TOTAL){
        var packaging_store = document.getElementById('packaging_store').value;
        if(packaging_store == ''){
            alert('Lütfen paketleme deposu seçiniz.');
            return;
       ...
       openBoxDraggable('index.cfm?fuseaction=product.popup_selected_karma_serialno&PRODUCT_ID='+PRODUCT_ID+'&QUANTITY='+QUANTITY+'&IS_SERIAL_NO='+IS_SERIAL_NO+'&PACKAGING_STORE='+packaging_store+'&MAIN_PRODUCT_ID='+MAIN_PRODUCT_ID+'&REQUIRED_TOTAL='+REQUIRED_TOTAL);
    }
