...
<cfset adres = "epda.prtotm_ambar_sevk&date1=#date1#&date2=#date2#&department_in_id=#attributes.department_in_id#&department_out_id=#attributes.department_out_id#&keyword=#attributes.keyword#&is_form_submitted=1">
<div style="width:100%">
