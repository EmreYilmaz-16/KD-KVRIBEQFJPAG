...
<cfquery name="UP" datasource="#DSN3#">
    UPDATE OFFER_ROW SET PRODUCT_ID=#RECORDED_PRODUCT_ID#,STOCK_ID=#RECORDED_STOCK_ID# WHERE WRK_ROW_ID=#arguments.OFFER_WRK_ROW_ID#
</cfquery>
<cfquery name="UP" datasource="#DSN3#">
    UPDATE OFFER_ROW SET PRODUCT_ID=#RECORDED_PRODUCT_ID#,STOCK_ID=#RECORDED_STOCK_ID# WHERE WRK_ROW_RELATION_ID=#arguments.OFFER_WRK_ROW_ID#
</cfquery>
