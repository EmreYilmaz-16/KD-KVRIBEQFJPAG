...
<cfquery name="GETICLof" datasource="#DSN3#">
  SELECT COUNT(*) AS SAYI FROM INTERNALDEMAND_ROW WHERE I_ID=#attributes.INTERNAL_ID# and SELECT_INFO_EXTRA<>6
</cfquery>
<cfdump var="#getrclof#">
<cfdump var="#GETICLof#">
...
<cfelse>
  ...
  <cfif isDefined("attributes.debug") and attributes.debug EQ 1>
  <cfoutput>
