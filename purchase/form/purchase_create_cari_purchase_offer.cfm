...
<cfquery name="GETALT" datasource="#DSN3#">
  SELECT * FROM w3Qa_1.OFFER_ROW WHERE OFFER_ID=81 AND PRODUCT_ID IN (SELECT ALTERNATIVE_PRODUCT_ID FROM w3Qa_1.ALTERNATIVE_PRODUCTS WHERE PRODUCT_ID=#PRODUCT_ID#)
</cfquery>
<cfdump var="#GETALT#">
