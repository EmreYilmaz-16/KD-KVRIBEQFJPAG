...
,CAST(PRICE AS DECIMAL(18, 2)) AS PRICE
  ...
  ,(SELECT BASKET_INFO_TYPE FROM w3Qa_1.SETUP_BASKET_INFO_TYPES WHERE BASKET_INFO_TYPE_ID=(w3Qa_1.fnGetSelectInfoExtra('WRK16020250513210114627935971'))) AS BASKET_INFO_TYPE
