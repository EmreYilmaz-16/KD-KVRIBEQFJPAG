...
,CAST(PRICE AS DECIMAL(18, 2)) AS PRICE
  ...
  ,(SELECT TOP 1 PRICE FROM CMP_PRICE_ALL WHERE STOCK_ID=OFFER_ROW.STOCK_ID AND COMPANY_ID=#GETDEMAND_MONEY.FROM_COMPANY_ID# AND PRICE>0 ORDER BY INVOICE_DATE DESC) AS LAST_PRICE
	, WRK_ROW_ID
