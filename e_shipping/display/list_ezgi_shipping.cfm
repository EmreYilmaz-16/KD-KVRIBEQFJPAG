...
<cfquery name="get_shipping_default" datasource="#dsn3#">
	SELECT ISNULL(SHIPPING_CONTROL_TYPE,2) SHIPPING_CONTROL_TYPE FROM EZGI_SHIPPING_DEFAULTS
</cfquery>
	...
	<table class="big_list">
		<thead>
			<tr height="15">
				...
				<th rowspan="2" style="width:400px;text-align:center"><cf_get_lang_main no='162.sirket'></th>
				...
				<th rowspan="2" style="text-align:center"><cf_get_lang_main no='217.Açıklama'></th>
				<!-- sil -->
                        ...
                        <cfif listlen(order_row_id_list)>
                       	...
                       	<cfelse>
                            ...
                            <tr>
								...
								<td><cfif get_shipping_default.SHIPPING_CONTROL_TYPE eq 1>#get_emp_info(sevk_emp,0,0)#<cfelse>#get_emp_info(get_control_emp.RECORD_EMP,0,0)#</cfif></td>
                                ...
                                <td style="text-align:center;
                                <cfif DURUM neq 1>background-color:red</cfif>">
                                
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=objects.popup_print_files&print_type=32&action_id=#is_type#-#SHIP_RESULT_ID#','page');"><img src="/images/print2.gif" alt="<cf_get_lang_main no='62.Yazdır'>" border="0" title="<cf_get_lang_main no='62.Yazdır'>">
                                <a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.emptypopup_print_svk_prtotm&print_type=32&action_id=#is_type#-#SHIP_RESULT_ID#','page');">Etiket</a>
                                </td>
                                <td style="text-align:right">
