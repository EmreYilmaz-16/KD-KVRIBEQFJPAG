...
LEFT JOIN #dsn#.DEPARTMENT AS D ON D.DEPARTMENT_ID=STORE
LEFT JOIN  #dsn#.STOCKS_LOCATION AS SL ON SL.LOCATION_ID=STORE_LOCATION AND SL.DEPARTMENT_ID=D.DEPARTMENT_ID
