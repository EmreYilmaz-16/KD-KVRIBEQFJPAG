...
<table style="width:100%">
    ...
    <td>
     <a href="<cfoutput>#request.self#?fuseaction=pda.form_add_ambar_fis</cfoutput>" class="tableyazi btncls"><img src="../../images/e-pd/down30.png"><h5>Mal Kabulden Ambara</h5></a>
        ...
        <tr>
    <td>
     <a href="<cfoutput>#request.self#?fuseaction=pda.form_add_ambar_fis_2</cfoutput>" class="tableyazi btncls"><img src="../../images/e-pd/exit30.png"><h5>Ambardan Mal Kabule</h5></a>
    </td>
    </tr>
        <tr>
    <td>
