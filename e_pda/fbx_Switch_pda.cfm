<cfswitch expression = "#fusebox.fuseaction#">
	...
	<cfcase value="emptypopup_add_ezgi_stock_count_file">
 		<cfinclude template="workcube_pda/query/add_ezgi_stock_count_file.cfm">
 	</cfcase>
	<cfcase value="emptypopup_add_ezgi_stock_count_loc_file">
 		<cfinclude template="workcube_pda/query/add_ezgi_stock_count_loc_file.cfm">
 	</cfcase>
	<cfcase value="list_pda_print_spool">
 		<cfinclude template="workcube_pda/display/list_pda_print_spool.cfm">
 	</cfcase>
	<cfcase value="emptypopup_ezgi_print_spool">
 		<cfinclude template="workcube_pda/query/add_ezgi_print_spool.cfm">
 	</cfcase>
	<cfcase value="emptypopup_del_ezgi_pda_print_spool">
 		<cfinclude template="workcube_pda/query/del_ezgi_print_spool.cfm">
 	</cfcase>
	<cfcase value="popup_ezgi_print_files">
 		<cfinclude template="workcube_pda/display/ezgi_print_files.cfm">
 	</cfcase>
	<cfcase value="emptypopup_ezgi_print_files_inner">
 		<cfinclude template="workcube_pda/display/ezgi_print_files_inner.cfm">
 	</cfcase>
</cfswitch>