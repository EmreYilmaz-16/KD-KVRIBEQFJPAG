...
<a href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_ezgi_shipping_Emre&id=#GetDepoStock.PRODUCT_ID[i]#','page');"title="Alınan Siparisler"><img src="/images/ship.gif" title="Alınan Siparişler" border="0"></a>
</cfoutput>
</td>
</tr>
</cfloop>
