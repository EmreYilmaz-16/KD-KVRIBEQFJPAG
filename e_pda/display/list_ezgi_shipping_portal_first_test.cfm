...
SELECT *
FROM catalystTest.catalystTest_1.EZGI_SHIP_RESULT AS es
	,catalystTest.catalystTest_1.EZGI_SHIP_RESULT_ROW AS esrr
...
<a class="tableyazi" href="javascript://" onclick="windowopen('#request.self#?fuseaction=sales.popup_upd_ezgi_shipping&iid=#SHIP_RESULT_ID#','page');" title="Alınan Siparisler">#DELIVER_PAPER_NO#</a>
</cfoutput>
</td>
</tr>
</cfif>
