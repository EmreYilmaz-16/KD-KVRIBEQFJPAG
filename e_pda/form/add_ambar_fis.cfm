...
<cfform name="form_basket" class="w-100">
	...
	<div class="card shadow-sm">
		<div class="card-body p-2 p-sm-4">
			...
			<div class="row mb-3">
				<div class="col-12">
					<div class="form-section-title mb-2">
						<i class="bi bi-house-door"></i> Depo Seçimi
					</div>
					<table class="table table-bordered table-sm mb-0">
						<thead class="table-light d-none d-sm-table-header-group">
							<tr>
								<th class="text-center" style="width:50%">Çıkış Depo</th>
								<th class="text-center" style="width:50%">Giriş Depo</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td>
									<select name="txt_department_out" class="form-select form-select-sm" onchange="document.getElementById('department_out').value = this.value">
										<cfoutput query="get_all_location" group="department_id">
											<option disabled value="#department_id#"<cfif attributes.department_out_id eq department_id>selected</cfif>>#department_head#</option>
											<cfoutput>
								...
								<td>
									<select name="txt_department_in" class="form-select form-select-sm" onchange="document.getElementById('department_in').value = this.value">
										<cfoutput query="get_all_location" group="department_id">
											<option disabled value="#department_id#"<cfif attributes.department_in_id eq department_id>selected</cfif>>#department_head#</option>
											<cfoutput>
			...
			<div class="row mb-3">
				<div class="col-12">
					<div class="form-section-title mb-2">
						<i class="bi bi-list-check"></i> Ürün Listesi
					</div>
					<table class="table table-bordered table-sm mb-0">
						<thead class="table-light d-none d-sm-table-header-group">
							<tr>
								<th class="text-center" style="width: 90px;">Barkod</th>
								<th class="text-center">Ürün Adı</th>
								<th class="text-end" style="width: 50px;">Mikt.</th>
								<th class="text-center" style="width: 90px;">Raf</th>
							</tr>
						</thead>
						<tbody>
							<tr>
								<td colspan="4" class="p-0">
									<!---  kontrol edilen tablo--->
									<form name="product_row" id="product_row" method="post">
										<table name="table1" id="table1" class="table table-sm mb-0">
			...
			<div class="row">
				<div class="col-12 text-end">
					...
					<input id="onay" name="Onay" value="<cf_get_lang_main no='49.Kaydet'>" type="button" class="btn btn-primary w-100 w-sm-auto" disabled="disabled" onClick="kontrol_kayit();" />
				</div>
			</div>
		</div>
	</div>
...
<!-- Bootstrap Icons (isteğe bağlı, ikonlar için) -->
