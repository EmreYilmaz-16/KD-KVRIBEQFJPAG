...
<cfform name="add_stock_count" id="add_stock_count" method="post" action="" enctype="multipart/form-data"> 
  ...
  <table cellpadding="2" cellspacing="1" align="left" class="color-border" width="99%">
    ...
    <tr class="color-list">
      <td colspan="5">
      	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="color-border">
           	<tr class="color-list">
            	<td align="center" width="40"><b>Depo</b></td>
            	<td width="100">
                    ...
                    <cfelse>
                          <select id="department_in_id" name="department_in_id" style="width:90px" onchange="document.getElementById('department_in').value = this.value">
                ...
                <td align="center" width="30"><b>Raf</b></td>
                <td width="70">
                	<cfoutput>
    ...
    <tr class="color-list">
      ...
      <td width="35" align="right">Miktar</td>
      <td width="35" align="right">Sayım</td>
      <td width="35" align="right">Sonuç</td>
    </tr>
