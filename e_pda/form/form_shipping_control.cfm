...
<cfquery name="" datasource="#DSN3#">
	SELECT ISNULL( (
	SELECT SERIAL_NO,STOCK_ID,(SELECT COUNT(*) FROM #dsn3#.PBS_SHIPPING_PACKAGE_LIST_SERIALS where SERIAL_NUMBER=SGN.SERIAL_NO) as IS_READ  FROM w3Qa_1.SERVICE_GUARANTY_NEW AS SG
INNER JOIN (
