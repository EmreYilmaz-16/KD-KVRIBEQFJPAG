    	...
    	SELECT     
            ...
            ISNULL(
                	(
                  	...
                  	FROM         
                    	workcube_rendimobilya_2015_1.dbo.EZGI_SHIP_PACKAGE_LIST
                   	WHERE     
...
{	
	...
	if(uzunluk > 9)
	{
		...
		var lot_sql = "SELECT TOP (1) SHIP_RESULT_ID FROM EZGI_SHIP_BARCOD WHERE SHIP_RESULT_ID ="+ship_id+"  AND IS_TYPE ="+is_type+"  AND LOT_NO = '"+lot_number+"' AND BARCOD = '"+barcode+"'";
